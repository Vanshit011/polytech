...
import { X, Atom, Wrench, Package, CheckCircle, MessageCircle } from 'lucide-react';
        ...
        <div className="p-6">
                  ...
                  <div className="space-y-2">
                    {product.features.map((feature, index) => (
                      <div key={index} className="flex items-center text-gray-700">
                        <CheckCircle size={16} className="mr-3 text-primary-500" />
                        <span>{feature}</span>
                      </div>
                    ))}
                  </div>
          ...
          {product.applications?.length > 0 && (
            <div className="mt-8 pt-8 border-t border-gray-200">
              ...
              <div className="bg-blue-50 rounded-xl p-6 grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          {product.properties?.length > 0 && (
            <div className="mt-8 pt-8 border-t border-gray-200">
              ...
              <div className="bg-primary-50 rounded-xl p-6 grid grid-cols-1 md:grid-cols-2 gap-3">
                {product.properties.map((prop, index) => (
                  <div key={index} className="flex items-start">
                    <div className="w-2 h-2 bg-primary-500 rounded-full mt-2 mr-3" />
                    <span className="text-primary-800 font-medium">{prop}</span>
                  </div>
                ))}
              </div>
            </div>
